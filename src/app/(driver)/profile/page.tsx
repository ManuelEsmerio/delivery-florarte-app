    ...
    <div className="p-6 pb-24 space-y-8 animate-in fade-in duration-300">
      ...
      <div className="space-y-3">
        <button 
          ...
          className="w-full bg-white p-5 rounded-2xl flex items-center justify-between shadow-sm active:scale-[0.98] transition-transform"
        >
        ...
        {showPasswordForm && (
          <form onSubmit={handlePasswordChange} className="bg-white p-6 rounded-2xl shadow-inner border-2 border-slate-50 space-y-4 animate-in slide-in-from-top-4 duration-300">
            <div className="space-y-2">
              ...
              <Input id="old-pass" type="password" required className="h-11" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="new-pass">New Password</Label>
              <Input id="new-pass" type="password" required className="h-11" />
            </div>
            <Button type="submit" className="w-full bg-primary h-12">Update Password</Button>
          </form>
        )}

        <button className="w-full bg-white p-5 rounded-2xl flex items-center justify-between shadow-sm active:scale-[0.98] transition-transform">
          <div className="flex items-center gap-3">
            <div className="bg-blue-50 p-2 rounded-lg text-primary">
        ...
        <button 
          ...
          className="w-full bg-red-50 p-5 rounded-2xl flex items-center justify-between border border-red-100 active:scale-[0.98] transition-transform"
        >
